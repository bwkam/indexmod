...
document.addEventListener("DOMContentLoaded", () => {
  ...
  templateFileInput.addEventListener("change", (e) => {
    ...
    reader.onload = function (e) {
      ...
      for (let condition of conditionsObject.conditions) {
        ...
        <button class="deleteButton">Delete</button>
        <div class="pairContainer" style="display: flex;">
          <input type="text" placeholder="Data" class="dataInput" value="${
            condition.data == undefined ? "" : condition.data
          }">
          <input type="text" placeholder="Title" class="titleInput" value="${
      ...
      `
        ...
        for (let intersection of condition.intersections) {
          ...
          <input type="text" placeholder="Data" class="intersectionDataInput" value="${
            intersection.data == undefined ? "" : intersection.data
          }">
          <input type="text" placeholder="Title" class="intersectionTitleInput" value="${
            condition.title == undefined ? "" : condition.title
          }">
          <button class="andButton">And</button>
        `
          inputPair
            .querySelector(".pairContainer")
            .appendChild(intersectionPair)
        }
      }
    }
  ...
  document.addEventListener("click", function (e) {
    if (e.target && e.target.classList.contains("andButton")) {
      ...
      conditionsObject.conditions[conditionIndex].intersections.push({
        data: "",
        title: "",
        intersections: [],
      })
  ...
  submitExcelButton.addEventListener("click", async (e) => {
    ...
    a.href = url
    a.download = `search${formatDate(date, "mmddyy")}${time.trim()}.xlsx`
